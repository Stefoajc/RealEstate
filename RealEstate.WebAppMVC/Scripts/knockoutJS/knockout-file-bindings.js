...
(function (factory) {
    ...
    var fileBindings = {
        ...
        defaultOptions: {
            ...
            noFileText: 'Не е избран файл',
            buttonGroupClass: 'input-group-btn',
            buttonClass: 'btn btn-primary',
            clearButtonClass: 'btn btn-default',
            buttonText: 'Изберете файл',
    ...
    function addRemoveCssClass(element, cssClasses, type){
        cssClasses = Array.isArray(cssClasses) ? cssClasses : cssClasses.split(' ');
    ...
    ko.bindingHandlers.fileInput = {
        init: function(element, valueAccessor) {
            ...
            fileData.clear = fileData.clear ||
                function() {
                    ['objectURL', 'base64String', 'binaryString', 'text', 'dataURL', 'arrayBuffer'].forEach(
                        function(property, i) {
            ...
            if(options.fileName){
                ...
                if (file && file.name) {
                    if(fileData.fileArray().length > 2){
                        fileNameInput.value = fileData.fileArray().length + ' файла';
                    }
                    else {
