...
using RealEstate.BindingModels;
using RealEstate.Model;
using RealEstate.Services;
using RealEstate.ViewModels.WebApi;
using RealEstate.WebApp.Providers;
using RealEstate.WebApp.Results;

namespace RealEstate.WebApp.Controllers
{
            ...
            foreach (AuthenticationDescription description in descriptions)
            {
                ExternalLoginViewModel login = new ExternalLoginViewModel
                {
                    ...
                    Url = Url.Route("ExternalLogin", new
                    {
                        ...
                        response_type = "token",
                        client_id = StartupWebApi.PublicClientId,
